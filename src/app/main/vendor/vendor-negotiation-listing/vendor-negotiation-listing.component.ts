...
import {negotiationDataCommonInterface} from "../../common-interface/common-interface";


@Component({
  selector: 'app-vendor-negotiation-listing',
  standalone: true,
  imports: [MatPaginatorModule, MatMenuModule, MatIconModule, NgForOf, DatePipe, DecimalPipe, NgIf],
  templateUrl: './vendor-negotiation-listing.component.html',
  styleUrl: './vendor-negotiation-listing.component.css'
})
export class VendorNegotiationListingComponent {
